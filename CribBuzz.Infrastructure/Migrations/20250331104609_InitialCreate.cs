        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RunRate = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiveScores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LiveScores_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LiveScores_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Commentaries_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Commentaries_Players_BatsmanId",
                        column: x => x.BatsmanId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Commentaries_Players_BowlerId",
                        column: x => x.BowlerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commentaries_BatsmanId",
                table: "Commentaries",
                column: "BatsmanId");

            migrationBuilder.CreateIndex(
                name: "IX_Commentaries_BowlerId",
                table: "Commentaries",
                column: "BowlerId");

            migrationBuilder.CreateIndex(
                name: "IX_Commentaries_MatchId",
                table: "Commentaries",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveScores_MatchId",
                table: "LiveScores",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_LiveScores_TeamId",
                table: "LiveScores",
                column: "TeamId");
